...
int main(int argc, char *argv[])
{
    ...
    int *dhits;
    cudaMalloc(&dtxs, NUMTRIALS * sizeof(float));
    cudaMalloc(&dtys, NUMTRIALS * sizeof(float));
    cudaMalloc(&dtxvs, NUMTRIALS * sizeof(float));
    cudaMalloc(&dsvs, NUMTRIALS * sizeof(float));
    cudaMalloc(&dsths, NUMTRIALS * sizeof(float));
    cudaMalloc(&dhalflens, NUMTRIALS * sizeof(float));
